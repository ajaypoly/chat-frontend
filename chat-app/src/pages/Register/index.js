      ...
      <FormContainer className="w-screen h-screen flex justify-center items-center bg-gradient-to-r from-slate-600 to-black ">
        <form onSubmit={(event) => handleSubmit(event)}>
          <div className="border border-[#ffffff4d]  rounded-3xl flex flex-col items-center gap-3 p-9 bg-white/20">
            ...
            <h1 className="text-black py-5 hover:text-[#fcf9f9] hover:scale-150 transition-all duration-1000">
              Come On
            </h1>
            <input
            ...
            <span>
              ...
              <a
                className="text-violet-200 ml-2 hover:text-[#000000] hover:scale-150 transition-all duration-700"
                href="/login"
              >
                Login
              </a>
